...
export const pintarEventos = async (eventos, elementoPadre, esPreferidos = false) => {
  ...
  console.log("🎨 DEBUGGING pintarEventos:")
  console.log("- Eventos recibidos:", eventos)
  console.log("- Cantidad de eventos:", eventos.length)
  console.log("- Es preferidos:", esPreferidos)
  ...
  for (const evento of eventos) {
    console.log("Pintando evento:", evento.nombre)
    ...
    console.log("✅ Evento añadido al contenedor:", evento.nombre)
    console.log("Total hijos ahora:", divEventos.children.length)
  }
  console.log("- Div eventos creado:", divEventos)
  console.log("- Hijos del div eventos:", divEventos.children.length)

  elementoPadre.append(divEventos)

  console.log("- Elemento padre después de append:", elementoPadre)
}
